...
Existem 2 momentos distintos de consumo de recursos: durante o **treinamento** da IA e durante o **uso** da IA (no qual o recurso é gasto no exato momento em que o modelo realiza a inferência). Esse tipo de impacto pode ser medido quantitativamente, como foi feito por uma equipe de pesquisadores da Univercidade da Califónia, que chegaram aos valores de que a cada 100 palavras em inglês um modelo utiliza cerca de 519 ml de água para sua refrigeração. 
