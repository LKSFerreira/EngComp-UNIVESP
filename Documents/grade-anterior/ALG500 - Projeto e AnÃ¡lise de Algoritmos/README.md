# ALG500 - Projeto e Análise de Algoritmos

## 📖 Ementa, Objetivos e Bibliografia
**Ementa:** Análise de complexidade de algoritmos (notação Big-O). Técnicas de projeto: divisão e conquista, programação dinâmica, algoritmos gananciosos. Teoria de grafos. Noções de complexidade de problemas (P, NP e NP-Completo).
