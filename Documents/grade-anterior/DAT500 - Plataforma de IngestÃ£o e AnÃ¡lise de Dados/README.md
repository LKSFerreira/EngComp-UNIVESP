# DAT500 - Plataforma de Ingestão e Análise de Dados

## 📖 Ementa, Objetivos e Bibliografia
**Ementa:** Arquitetura moderna de dados. Processamento de dados em lotes (Batch) e fluxo contínuo (Streaming). Ferramentas de ETL e pipelines. Hadoop, Spark, Kafka e ferramentas de armazenamento de Big Data.
