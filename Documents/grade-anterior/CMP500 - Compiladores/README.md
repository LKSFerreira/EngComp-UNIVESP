...
**Ementa:** Fases de compilação. Análise léxica e sintática (automatos e gramáticas livres de contexto). Verificação de tipos. Geração de código intermediário e geração de código de máquina.
