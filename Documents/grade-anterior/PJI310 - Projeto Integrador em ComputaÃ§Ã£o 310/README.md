# PJI310 - Projeto Integrador em Computação 310

## 📖 Ementa, Objetivos e Bibliografia
**Ementa:** Desenvolvimento de um projeto prático que envolva a aplicação dos conhecimentos adquiridos no curso em um contexto real, por meio do trabalho em equipe.
