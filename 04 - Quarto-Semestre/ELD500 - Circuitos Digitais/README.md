# ELD500 - Circuitos Digitais

## 📖 Ementa, Objetivos e Bibliografia
**Ementa:** Conceitos básicos de projeto lógico. Portas lógicas. Minimização de funções lógicas. Circuitos combinacionais. Elementos de memória (latch, flip-flops, contadores). Síntese e simulação de circuitos digitais com HDL (SystemVerilog). Máquinas de estado. Processador básico.
