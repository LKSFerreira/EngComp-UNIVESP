...
Correta	
Qual é a cláusula do comando SELECT que é responsável por estabelecer uma condição para a consulta?
...
Comentário da resposta:	
Você acertou! Essa é a alternativa correta. A cláusula WHERE é responsável por estabelecer uma condição de consulta no comando SELECT.
...
Correta	
Qual das funções de agregação tem como funcionalidade retornar o maior valor existente para um campo?
...
Comentário da resposta:	
Você acertou! Essa é a alternativa correta. A função de agregação que retorna o maior valor existente para um campo é a função MAX.
