...
**Ementa:** Arquiteturas Web (MVC, REST, Microsserviços). Tecnologias de frontend baseadas em Javascript (React/Vue). Frameworks backend (Django/Node). Escalabilidade e concorrência.
