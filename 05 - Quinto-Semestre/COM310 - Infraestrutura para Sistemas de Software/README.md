...
**Ementa:** Redes de computadores e a internet. Noções de redes TCP/IP. Máquinas virtuais. Computação em nuvem (VMs, BDs, persistência, efemeridade). Contêineres e desenvolvimento usando Docker.
