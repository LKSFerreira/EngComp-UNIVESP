...
**Ementa:** Introdução aos sistemas ciberfísicos. Conversão analógica-digital (ADC) e digital-analógica (DAC). Circuitos eletrônicos para sensoriamento. Sensores analógicos e digitais. Consumo de energia e programação em placas de desenvolvimento (Arduino/microcontroladores).
