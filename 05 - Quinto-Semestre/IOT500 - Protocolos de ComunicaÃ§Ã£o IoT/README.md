# IOT500 - Protocolos de ComunicaÃ§Ã£o IoT

## ðŸ“– Ementa, Objetivos e Bibliografia
**Ementa:** VisÃ£o geral da arquitetura ISO/OSI e TCP/IP em IoT. PadrÃµes de comunicaÃ§Ã£o: um-para-um, um-para-muitos, muitos-para-um. Protocolos de enlace e fÃ­sicos (Bluetooth, IEEE 802.15.4, ZigBee, LoRaWAN, NB-IoT). IPv6 e 6LoWPAN. Protocolos de transporte e aplicaÃ§Ã£o (CoAP, MQTT, UDP).
